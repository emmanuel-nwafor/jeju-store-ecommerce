...
const SearchExample = () => {
  ...
  return (
    <div
      className=" max-md:flex-col p-7 h-[50vh] bg-[url('/src/assets/img2.jpg')]
     bg-cover bg-no-repeat flex justify-evenly max-md:justify-center items-center "
    >
      <div className="">
        <h1 className="text-center text-[50px] max-md:text-[45px] font-extrabold ">
          Je <span className="text-zinc-500 ">Ju</span>{" "}
          <span className="text-[50px] max-md:text-[25px] ">Stores</span>
        </h1>
        <p className="text-cyan-600 max-md:text-center md:text-center lg:text-left xl:text-left ">
      ...
      <input
        ...
        className="m-2 w-[360px] max-md:w-full rounded-full p-3 border focus:outline-none focus:ring focus:ring-blue-300"
      />
